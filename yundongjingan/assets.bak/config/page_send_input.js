                ...
                return $A().page().param("info").then(function(info) {
                                                      ...
                                                      $A().app().callApi({
                                                                         ...
                                                                         cacheTime: 0
                                                                                 ...
                                                                                 $A().app().log("data" + JSON.stringify(data));
                                                                                 $A().app().log("data0" + data.order.consignee_name);
                                                                                 $A().app().log("data1" + data.order.consignee_address);
                                                                                 $A().app().log("data3" + data.order.consignee_zip);
                                                                                 $A().app().log("data2" + data.order.phone);
                                                                                 ...
                                                                                 root._listview_data.data[2].inputText = String(data.order.phone);
                                                                                 root._listview_data.data[3].inputText = String(data.order.consignee_zip);

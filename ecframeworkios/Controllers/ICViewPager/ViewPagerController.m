...
- (void)viewWillAppear:(BOOL)animated {
    //    NSLog(@"ViewPagerController viewWillAppear......");
...
- (void)setTabHeight:(NSNumber *)tabHeight {
    if ([tabHeight floatValue] == 0)
        tabHeight = 0;
    else if ([tabHeight floatValue] < 4.0)
...
- (void)setStartFromSecondTab:(NSNumber *)startFromSecondTab {
    ...
    if ([startFromSecondTab floatValue] != 1.0 && [startFromSecondTab floatValue] != 0.0)
        startFromSecondTab = [startFromSecondTab intValue] > 0 ? [NSNumber numberWithInt:[startFromSecondTab intValue]] : 0;
...
- (void)defaultSetup {
    ...
    // Select starting tab  //zzm startFromSecondTab

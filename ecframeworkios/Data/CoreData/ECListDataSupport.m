...
#define kCoreDataFileName   @"com.ecloud.ios.coredata.coredatalistfilename"
#define kCoreDataModelFileName  @"List"

@implementation ECListDataSupport

#pragma mark - 单例
+ (id)sharedInstance{
    static ECListDataSupport* object = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        object = [[ECListDataSupport alloc] init];
    });
    return object;
}
#pragma mark -

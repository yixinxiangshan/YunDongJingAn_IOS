...
- (void)makeToastActivity:(id)position {
    ...
    [activityIndicatorView setBackgroundColor:[[UIColor clearColor] colorWithAlphaComponent:CSToastOpacity]];
    ...
    objc_setAssociatedObject (self, &CSToastActivityViewKey, activityOverlay, OBJC_ASSOCIATION_RETAIN_NONATOMIC);

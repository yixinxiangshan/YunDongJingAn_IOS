...
{
    [self addButtonWithTitle:title color:@"blueline" block:block];
}

- (void)setDestructiveButtonWithTitle:(NSString *)title block:(void (^)())block
{
    [self addButtonWithTitle:title color:@"blue" block:block];
}
...
#pragma clan diagnostic pop
        ...
        if ([color isEqual:@"blueline"]) {
            [button setTitleColor:[UIColor colorWithRed:107.0/255 green:160.0/255 blue:255.0/255 alpha:1.0] forState:UIControlStateNormal];
